...
3. **Scaffold** a new [SvelteKit](https://svelte.dev/docs/kit) app inside a [Turborepo](https://turbo.build/repo) monorepo.
...
| Styling    | **TailwindCSS**     | Build responsive, mobile- and web-friendly pages from designs |
...
- **Scaffold** — A new SvelteKit app is created inside a Turborepo monorepo, ready for the new designs.
...
- [ ] SvelteKit + Turborepo scaffolding
